      ...
      >
        ...
        >
          <Box className="form-field" sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
            ...
            <TextField name="name" required fullWidth placeholder="John Doe" variant="outlined" sx={formInputStyles} />
          </Box>
          <Box className="form-field" sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
            <Typography variant="subtitle2" sx={{ fontWeight: 700, color: "#1a1a1a" }}>Phone</Typography>
            <TextField name="phone" fullWidth placeholder="+91 (555) 000-0000" variant="outlined" sx={formInputStyles} />
          </Box>
          <Box className="form-field" sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
            <Typography variant="subtitle2" sx={{ fontWeight: 700, color: "#1a1a1a" }}>Email *</Typography>
            <TextField name="email" type="email" required fullWidth placeholder="john@example.com" variant="outlined" sx={formInputStyles} />
          </Box>
          <Box className="form-field" sx={{ display: "flex", flexDirection: "column", gap: 1 }}>
            <Typography variant="subtitle2" sx={{ fontWeight: 700, color: "#1a1a1a" }}>Subject *</Typography>
            <TextField name="subject" required fullWidth placeholder="How can we help?" variant="outlined" sx={formInputStyles} />
          </Box>
          <Box className="form-field" sx={{ gridColumn: { xs: "span 1", md: "span 2" }, display: "flex", flexDirection: "column", gap: 1 }}>
            ...
            <TextField name="message" required fullWidth multiline rows={3} placeholder="Tell us more about your inquiry..." variant="outlined" sx={formInputStyles} />
          </Box>
          <Button
